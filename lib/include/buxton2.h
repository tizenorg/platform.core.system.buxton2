 ...
 * @return 0 on success, -1 on error(when an error occurred, errno is set)
 */
int buxton_security_enable(struct buxton_client *client,
		buxton_response_callback callback, void *user_data);
 ...
 * @return 0 on success, -1 on error(when an error occurred, errno is set)
 */
int buxton_security_enable_sync(struct buxton_client *client);
 ...
 * @return 0 on success, -1 on error(when an error occurred, errno is set)
 */
int buxton_security_disable(struct buxton_client *client,
		buxton_response_callback callback, void *user_data);
 ...
 * @return 0 on success, -1 on error(when an error occurred, errno is set)
 */
int buxton_security_disable_sync(struct buxton_client *client);
